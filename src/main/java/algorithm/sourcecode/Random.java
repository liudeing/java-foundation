package algorithm.sourcecode;// Random class
//
...
/**
 * Random number class, using a 31-bit linear congruential generator. Note that java.util contains a
 * class Random, so watch out for name conflicts.
 *
