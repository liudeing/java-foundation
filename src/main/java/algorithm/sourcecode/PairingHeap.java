...
/**
 * Implements a pairing heap. Supports a decreaseKey operation. Note that all "matching" is based on
...
public class PairingHeap<AnyType extends Comparable<? super AnyType>> {
    ...
    /**
     * Internal method that is the basic operation to maintain order. Links first and second
     * together to satisfy heap order.
     *
     * @param first root of tree 1, which may not be null. first.nextSibling MUST be null on entry.
