package algorithm.sourcecode;// SplayTree class
//
...
public class SplayTree<AnyType extends Comparable<? super AnyType>> {
    ...
    /**
     * Find the smallest item in the tree. Not the most efficient implementation (uses two passes),
     * but has correct amortized behavior. A good alternative is to first call find with parameter
    ...
    /**
     * Find the largest item in the tree. Not the most efficient implementation (uses two passes),
     * but has correct amortized behavior. A good alternative is to first call find with parameter
    ...
    /**
     * Rotate binary tree node with left child. For AVL trees, this is a single rotation for case
     * 1.
     */
    ...
    /**
     * Rotate binary tree node with right child. For AVL trees, this is a single rotation for case
     * 4.
     */
