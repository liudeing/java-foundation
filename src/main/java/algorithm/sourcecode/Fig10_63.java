...
public class Fig10_63 {
    ...
    /**
     * Method that implements the basic primality test. If witness does not return 1, n is
     * definitely composite. Do this by computing a^i (mod n) and looking for nontrivial square
     * roots of 1 along the way.
     */
